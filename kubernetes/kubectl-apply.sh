...
logSummary() {
    echo ""
        ...
        echo "Gateway - http://store.jhipster.20.204.236.196.nip.io"
        echo "Zipkin - http://zipkin.istio-system.20.204.236.196.nip.io"
        echo "Grafana - http://grafana.istio-system.20.204.236.196.nip.io"
        echo "Kiali - http://kiali.istio-system.20.204.236.196.nip.io"
        echo "#####################################################"
}
